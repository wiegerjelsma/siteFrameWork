<?php
/**
 * @name	/nieuws_detail.tpl
 * @version	1.0 2013-10-14 13:43:33
 *
 * @usage:	<?php $this->includeTpl('/nieuws_detail.tpl'); ?>
 */
?>
<?php $this->includeTpl('includes/header.tpl'); ?>
					...
					<div id="content" class="row" data-equalizer>
						...
						<div id='column-right' class="columns large-17 medium-24" data-equalizer-watch>
							...
							<h4><?=$this->format($this->Nieuws['datum'], 'date', '%d %B %Y')?></h4>
							<h1><?=$this->Nieuws['titel']?></h1>
							<?=$this->Nieuws['body']?>						
