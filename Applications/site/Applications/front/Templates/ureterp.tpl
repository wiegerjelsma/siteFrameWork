<?php $this->includeTpl('includes/header.tpl'); ?>
					...
					<div id="content" class="row">
						...
						<div id='column-right' class="columns large-17 medium-24">
							...
							<h1>OsteoVitaal praktijk Ureterp, Friesland</h1>	
							...
							<div id="binnenkijken-popup" class="reveal-modal" style='height: 600px;' data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog" data-lat='53.093732' data-lng='6.16722' data-heading='-150' data-pitch='1'> 
  								<h2 id="modalTitle">Binnenkijken bij OsteoVitaal Ureterp, Friesland</h2>
							...
							<a id='binnenkijken' data-reveal-id="binnenkijken-popup">
								...
								<img src="<?=WEBROOT?>/images/binnenkijken-ureterp.jpg" alt="" />
							</a>
							...
							<div class="row">
								<div class="columns small-24 medium-12">
									<p><img src="http://osteovitaal.nl/site/site.front/file/image/bd0a2c3e0d69739bd2a058803006a5f6-PraktijkUreterp-l.jpg" alt="Praktijk Ureterp"></p>	
								</div>
								<div class="columns small-24 medium-12">
									<p><img src="http://osteovitaal.nl/site/site.front/file/image/e9c20cb1801b990fe5bd0c3d35b75c2d-wachtruimte-admin-l.jpg" alt="Behandelkamer Ureterp"></p>
								</div>	
							</div>													
